1. scheidt de engelse en de nederlandstalige versies (toggle tussen nederlandstalige en engelstalige website versies)
2. fleur de website op (kleuren, lettertypes, lettergroottes, background picture...)
3. "Section X:" captions tegengaan / weglaten
4. wat moet er gebeuren met 'layouts/partials/summary.html'? :
"""
